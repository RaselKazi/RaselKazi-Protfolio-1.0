...
export default function Portfolio() {
  ...
  return (
    <div
      ref={element}
      id="Portfolio"
      className="dark:bg-gray-900 relative overflow-hidden"
    >
      ...
      <div className="bg-gray-400/10 backdrop-blur ">
        <div className="px-4  py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 ">
          ...
          <div className="grid gap-10 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4   transition-all  duration-500 dark:text-gray-700">
